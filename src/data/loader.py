...
def load_city_data() -> Tuple[Dict[str, CityData], List[str], bool, Optional[Dict[str, float]]]:
    """
    Load city scoring data from the Excel workbook.

    Returns:
        (city_data_map, quality_notes, from_workbook, workbook_weights)
    ...
    parsed, wb_weights = parse_rh_workbook(_WORKBOOK_PATH)
    ...
    return parsed, notes, True, wb_weights
